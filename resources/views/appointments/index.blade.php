        ...
        <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
            <div class="p-6">
                @if(Auth::user()->hasRole('Front Desk/Billing Staff'))
                    <a href="{{ route('appointments.create') }}" class="bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold py-2 px-4 rounded mb-4 inline-block">
                ...
                <table class="min-w-full bg-white rounded-lg overflow-hidden shadow-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="py-3 px-4 border-b">{{ $appointment->patient->user->name }}</td>
                            <td class="py-3 px-4 border-b">{{ $appointment->doctor->user->name }}</td>
                            ...
                            <td class="py-3 px-4 border-b">
                                <a href="{{ route('appointments.show', $appointment) }}" class="text-blue-500">View</a>
                                @if(Auth::user()->hasRole('Front Desk/Billing Staff'))
                                    | <a href="{{ route('appointments.edit', $appointment) }}" class="text-indigo-500">Edit</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
