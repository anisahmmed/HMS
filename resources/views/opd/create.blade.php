    ...
    <div class="p-6">
        ...
        <nav>
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('opd.index') }}" class="flex items-center p-3 rounded group transition-colors duration-300 bg-white bg-opacity-30">
                        <svg class="w-7 h-7 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-6 text-gray-900">
                <form method="POST" action="{{ route('opd.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="patient_search" class="mt-1 block w-full border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Search by name, email, or hospital ID">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="doctor_id" id="doctor_id" class="mt-1 block w-full border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="fee_amount" id="fee_amount" step="0.01" class="mt-1 block w-full border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                    </div>

                    <div class="mb-4">
                        <label for="visit_time" class="block text-sm font-medium text-gray-700">Visit Time (Optional)</label>
                        <input type="time" name="visit_time" id="visit_time" class="mt-1 block w-full border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>

                    <button type="submit" class="bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold py-2 px-4 rounded-lg">
                        Create OPD <span :class="sidebarOpen ? 'inline' : 'hidden group-hover:inline'" class=ml-3>Ticket</span>
                    </button>
                </form>
            </div>
        </div>
