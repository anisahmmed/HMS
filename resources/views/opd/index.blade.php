    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="mb-4">
                    <a href="{{ route('opd.create') }}" class="bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold py-2 px-4 rounded">
                        Create New OPD <span :class="sidebarOpen ? 'inline' : 'hidden group-hover:inline'" class=ml-3>Ticket</span>
                    </a>
                </div>
                ...
                <table class="min-w-full bg-white rounded-lg overflow-hidden shadow-sm">
                    <thead class="bg-gradient-to-r from-blue-500 to-purple-500 text-white">
                        <tr>
                            <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider">Ticket Number</th>
                            <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider">Patient</th>
                            <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider">Doctor</th>
                            <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider">Visit Time</th>
                            <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider">Fee</th>
                        ...
                        @foreach($currentOPDVisits as $visit)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('opd.show', $visit->patient_id) }}" class="text-blue-500">View History</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
